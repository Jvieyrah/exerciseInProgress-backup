...
class ContaTest {
  ...
  void construtorTest() {
    ...
    PessoaCliente pessoaCliente = new PessoaCliente("José silva", "123.456.789-13", "123456");
    Conta novaConta = new Conta("Corrente", pessoaCliente, newBank);
    assertEquals(pessoaCliente, novaConta.getPessoaCliente());
  }
